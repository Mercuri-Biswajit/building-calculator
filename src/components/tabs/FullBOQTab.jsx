...
function TotalsRow({ summary, colour }) {
  return (
    ...
    >
      <span>
        Subtotal: <strong>₹{fmtI(summary.subtotal)}</strong>
      </span>
      <span>
        GST @18%: <strong>₹{fmtI(summary.gst)}</strong>
      </span>
      <span
        style={{
          fontSize: "1rem",
    ...
    <div>
      ...
      >
        ...
        <span
          style={{ marginLeft: "auto", fontSize: "0.78rem", color: "#64748b" }}
        >
          M25 · OPC 53 · Fe500D · Vitrified tiles · Asian Royale · UPVC windows
          · Jaquar
        </span>
      </div>
      <SummaryBanner boq={boq} colour={col} />
  ...
  return (
    <div>
      ...
      >
        ...
        >
          <span>
            Subtotal: <strong>₹{fmtI(current.summary.subtotal)}</strong>
          </span>
          <span>
            GST @18%: <strong>₹{fmtI(current.summary.gst)}</strong>
          </span>
