// ═══════════════════════════════════════════════════════════════════════════
// BOQ CALCULATOR TAB — New Tab Component
// Aapke existing project ke design system ke saath match karta hai
// Fonts: Syne (headings), Instrument Sans (body), JetBrains Mono (numbers)
// Colors: --ink, --paper, --accent, --border, --muted (same as your project)
// ═══════════════════════════════════════════════════════════════════════════
// INTEGRATION GUIDE:
//   1. Is file ko src/components/tabs/BOQCalculator.jsx mein rakho
//   2. Apne main tab file mein import karo:
//      import BOQCalculator from './tabs/BOQCalculator';
//   3. Tab list mein add karo:
//      { id: 'boq', label: 'BOQ', icon: '📋', component: <BOQCalculator /> }
//   4. CSS variables already aapke project mein hain — kuch add nahi karna
// ═══════════════════════════════════════════════════════════════════════════
  ...
  return (
    <div>
      ...
      >
        ...
        >
          Yeh information official BOQ document mein dikhegi
        </p>
      </div>
      <div
        style={{
...
// PAGE 5 — Results & BOQ
// ─────────────────────────────────────────────────────────────────────────
function Page5({ formData, floorRooms, result, onRestart }) {
...
function LoadingOverlay({ show }) {
  if (!show) return null;
  const steps = [
    "Plot analysis & column grid…",
    "Column sizing per IS:456",
    "Footing dimensions & depth",
    "Plinth beam & DPC calculation",
...
export default function BOQCalculator() {
  ...
  // Re-init floor rooms when numFloors changes
