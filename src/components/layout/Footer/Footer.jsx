    ...
    <footer className="footer">
        ...
        <div className="container">
          <div className="footer-top-inner">
            <div className="footer-top-left">
              <span className="footer-top-eyebrow">Civil Engineer &amp; Structural Designer</span>
            ...
            <div className="footer-top-right">
              ...
              <a href="mailto:biswajitdebbarman.civil@gmail.com" className="footer-top-cta">
                Hire Me
      ...
      <div className="container">
        <div className="footer-main">
          ...
          <div className="footer-contact-col">
            <Link to="/" className="footer-logo-link">
              <img src="/assets/icons/My__Logo.png" alt={SITE.name} className="footer-logo-img" />
            </Link>
            <p className="footer-tagline">
              Providing expert structural design and civil engineering solutions across West Bengal.
              Building strong foundations, one project at a time.
            </p>
            ...
            <div className="footer-contact-list">
              <div className="footer-contact-row">
                ...
                <div className="footer-contact-info">
                  ...
                  <span className="footer-contact-val">Chanditala, Raiganj, Uttar Dinajpur, WB – 733134</span>
                </div>
              </div>
              ...
              <a href="mailto:biswajitdebbarman.civil@gmail.com" className="footer-contact-row">
                <div className="footer-contact-icon">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                    strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div className="footer-contact-info">
                  ...
                  <span className="footer-contact-val">biswajitdebbarman.civil@gmail.com</span>
                </div>
              </a>
            </div>
          </div>
          ...
          <div className="footer-connect-col">
            ...
            <div className="footer-connect-list">
              <a href={SITE.linkedin} target="_blank" rel="noreferrer" className="footer-connect-item">
              ...
              <a href={SITE.facebook} target="_blank" rel="noreferrer" className="footer-connect-item">
                <span className="footer-connect-icon">
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href={SITE.instagram} target="_blank" rel="noreferrer" className="footer-connect-item">
                <span className="footer-connect-icon">
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="footer-bottom">
          <p>© 2026 Er. Biswajit Deb Barman — Civil Engineer, Raiganj, West Bengal. All rights reserved.</p>
          <span className="footer-bottom-right">Civil · Structural · Design</span>
        </div>
      </div>
